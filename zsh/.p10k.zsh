# Generated by Powerlevel10k configuration wizard on 2025-11-25 at 10:36 PST.
...
() {
  ...
  # Inherit colors from Ghostty terminal theme (Vesper)
  local grey='8'      # bright black
  local red='1'       # red
  local yellow='3'    # yellow
  local blue='4'      # blue
  local magenta='5'   # magenta
  local cyan='6'      # cyan
  local white='7'     # white
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    command_execution_time    # previous command duration
    # virtualenv              # python virtual environment (moved to left)
    context                   # user@host
    time                      # current time
    # =========================[ Line #2 ]=========================
    newline                   # \n
  ...
  # Yellow Python Virtual Environment.
  ...
  # Show the number of staged files
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='+'
  typeset -g POWERLEVEL9K_VCS_STAGED_MAX_NUM=-1  # -1 means show all
